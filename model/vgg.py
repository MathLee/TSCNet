...
class VGG(nn.Module):
    ...
    def __init__(self, mode = 'rgb'):
        ...
        conv5 = nn.Sequential()
        conv5.add_module('pool4', nn.MaxPool2d(2, stride=2)) # np pool to keep high resolution
        ...
        pre_train = torch.load('/home/lgy/lgy/20230106_DSNet_ORSI_1/model/vgg16-397923af.pth')
